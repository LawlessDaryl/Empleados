                    ...
                    <table class="table table-unbordered table-hover mt-2">
                        <thead class="text-white" style="background: #3B3F5C">
                            <tr>
                                ...
                                <th class="table-th text-withe text-center">Condición</th>
                        ...
                        <tbody>
                            @foreach ($data as $user)
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-center">{{ $user->password }}</h6>
                                    </td>
                                    <td>
                                        <h6 class="text-center">{{ $user->condition }}</h6>
                                    </td>      
                                    <td>
                                        <h6 class="text-center">{{ $user->person_id }}</h6>
                                    </td>                               
